...
`XMCircleTypeView` is a UIView that allows you to display an NSString as a circular text. Is will take font kerning into account, so no weird spacings. It is a Swift port of my [earlier Objective-C version](https://github.com/MichMich/XMCircleType).
